...
<div class="pagetitle">
  <h1>Affichage de toutes les ventes pour un jour donné</h1>
  <nav>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="card">
                ...
                <h5 class="card-title">Rechercher vente par date</h5>

                <form class="d-flex" method="post" action="">
                <div class="col-sm-8">
                    <input class="form-control" name="date" type="date" placeholder="Entrer la date" aria-label="Search">
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        $allVentes = $ventes->selectSaleForDay(htmlentities($_POST['date']));
